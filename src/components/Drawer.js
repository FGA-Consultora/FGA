...
export const Carrousel = () => {
  ...
  return (
      <>
          <label htmlFor="my-drawer" className="btn btn-primary fixed drawer-button z-30 top-0 right-0" onClick={clickHandler} >open menu</label>

          <div className={`drawer fixed h-screen w-full ${fullPage} `} >
              <input id="my-drawer" type="checkbox" className="drawer-toggle" defaultChecked={isOpen} />
              <div className="drawer-side">
                  ...
                  <ul className='p-6 overflow-y-auto w-80 bg-base-100 flex-col scroll_custom scroll_black'>
                      <li><a href='#section-projects' className='btn w-full mb-5' >Projects</a> </li>
