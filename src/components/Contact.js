          ...
          <div ref={sectionCont1} className={`w-full max-w-[550px] items-center justify-center ${isSectionCont1Visible ? "slider-btn-shower2" : ""}`}>
            <form action="" method="POST">
              ...
              <div className="text-center">
                <button type="submit" value="send" className="hover:shadow-form rounded-md bg-sky-700 py-3 px-8 text-base font-semibold text-white outline-none">Enviar</button>
              </div>
            </form>
          </div>
