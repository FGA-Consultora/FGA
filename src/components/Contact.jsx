...
const Contact = () => {
  ...
  return (
    <>
      {/*Contact*/}
      <div className="font-Roboto hero h-[75rem] md:h-[65rem] lg:h-[45rem] lg:px-20 lg:py-5 mx-auto" style={{ backgroundImage: `url(../img/form.webp)` }}>
        <div className="hero-content gap-12 flex-col-reverse lg:flex-row-reverse">
          ...
          <div ref={sectionCont2} className={`justify-center text-center items-center mx-8 max-w-[550px] sm:max-w-none lg:mx-18 slider-btn ${isSectionCont2Visible ? "slider-btn-shower2" : ""}`}>
            ...
            <div className={`mt-2 mx-auto h-44 w-44 bg-cover slider-btn ${isSectionCont2Visible ? "slider-btn-shower2" : ""}`} style={{ backgroundImage: `url(../img/QR.webp)` }}></div>
          </div>
        </div>
      </div>
    </>
