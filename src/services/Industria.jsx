...
<div className="font-Roboto justify-center text-center items-center bg-amber-50">
    ...
    <ul className="sm:ml-32 md:ml-48 lg:ml-96 space-y-5 sm:space-y-6 md:space-y-7 lg:space-y-8 text-lg sm:text-lg md:text-xl lg:text-2xl py-8 font-medium justify-center text-left items-center">
